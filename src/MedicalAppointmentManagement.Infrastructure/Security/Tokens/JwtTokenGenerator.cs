...
namespace MedicalAppointmentManagement.Infrastructure.Security.Tokens;
public class JwtTokenGenerator : IAccessTokenGenerator
{
    ...
    {
        _expirationTimeMinutes = jwtSettings.ExpiresMinutes;
        _signingKey = jwtSettings.SigningKey;
    }
